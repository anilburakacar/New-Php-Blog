        ...
        <div class="col-md col-12 pb-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Projelerinize hayat verip dinamiklik katıyorum.Projelerinize hayat verip dinamiklik katıyorum.</p>
        ...
        <div class="col-md col-12 pb-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">React-Native ile yapabilirim. Native Uygulama.</p>
